...
class ToggleIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        {
            ###### Newly Added test case to test a video that is currently on the site
            "url": "https://www.mewatch.sg/watch/Seraph-Sun-Aloysius-will-suddenly-sing-some-old-songs-in-high-pitch-on-set-84901",
            "only_matching": True,
        },
        {
            ###### Newly Added test case to test a video that is currently on the site using it's video ID
            "note": "Updated video that exists on the website",
            "info_dict": {
                "id": "413339"
            }
        },
